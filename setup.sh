...
echo ""
echo "  2. Install runtimes (Node LTS + Python 3.12) via mise:"
echo "       mise install"
echo ""
echo "  3. Authenticate GitHub CLI:"
echo "       gh auth login"
echo ""
echo "  4. Store API keys in macOS Keychain (never in files):"
echo "       security add-generic-password -a \"\$USER\" -s ANTHROPIC_API_KEY -w"
echo "       # Paste the key value when prompted"
echo ""
echo "  5. (Optional) Enable GPG commit signing:"
